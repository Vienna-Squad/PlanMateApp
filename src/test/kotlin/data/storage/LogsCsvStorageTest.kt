...
//        assertThat(savedLog.affectedId).isEqualTo("task123")
...
//        assertThat(savedLog.username).isEqualTo("user1")
//        assertThat(savedLog.affectedId).isEqualTo("user456")
//        assertThat(savedLog.addedTo).isEqualTo("project123")
//    }
//
//    @Test
...
//        assertThat(savedLog.username).isEqualTo("user1")
//        assertThat(savedLog.affectedId).isEqualTo("state123")
//        assertThat(savedLog.deletedFrom).isEqualTo("project456")
//    }
//
//    @Test
...
//        assertThat(savedLog.username).isEqualTo("user1")
//        assertThat(savedLog.affectedId).isEqualTo("project123")
...
//        // Given
//        val log1 = CreatedLog("user1", "project1", Log.AffectedType.PROJECT,
//            LocalDateTime.parse("2023-01-01T10:00:00"))
//        val log2 = AddedLog("user1", "user2", Log.AffectedType.MATE,
//            LocalDateTime.parse("2023-01-01T10:15:00"), "project1")
//        val log3 = ChangedLog("user2", "task1", Log.AffectedType.TASK,
