...
class ProjectsCsvRepositoryTest {
    private lateinit var repository: ProjectsCsvRepository
    ...
    fun setup() {
        ...
        repository = ProjectsCsvRepository(storage)
    }
    ...
    fun `should add project successfully when add is called`() {
        ...
        // When
        val result = repository.add(project1)
    ...
    fun `should return failure when update is called with non-existent project`() {
        ...
        // When
        val result = repository.update(project1)
